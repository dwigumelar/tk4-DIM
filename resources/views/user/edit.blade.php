          ...
          <form action="{{ route('user.update',$user->id_user) }}" method="POST">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ $user->username }}" required autocomplete="username" placeholder="Masukan Username" autofocus>
                @error('username')
              ...
              <div class="form-group">
                ...
                <input id="role" type="text" class="form-control @error('role') is-invalid @enderror" name="role" value="{{ $user->role }}" required autocomplete="role" autofocus placeholder="Masukan Role">
                @error('role')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="form-group">
                ...
                <select class="form-control select2bs4 @error('id_pegawai') is-invalid @enderror" id="id_pegawai" name="id_pegawai" style="width: 100%;">
                  @foreach($pegawai as $pegawai)
                  <option selected value="{{ $user->id_pegawai }}">{{ $user->id_pegawai }}</option>
