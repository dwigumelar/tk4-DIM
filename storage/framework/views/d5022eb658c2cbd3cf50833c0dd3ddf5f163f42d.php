...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="id_pegawai" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Id Pegawai')); ?></label>

                            <div class="col-md-6">
                                <input id="id_pegawai" type="text" class="form-control <?php $__errorArgs = ['id_pegawai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="id_pegawai" value="<?php echo e(old('id_pegawai')); ?>" required autocomplete="id_pegawai" autofocus>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tk4\resources\views/auth/register.blade.php ENDPATH**/ ?>